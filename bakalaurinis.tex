...
\input{./sections/bpmn.tex}
\input{./sections/dvcm.tex}
\input{./sections/use_cases.tex}
\input{./sections/transforming_algorythms.tex}
\input{./sections/use_case_from_bpmn.tex}
\input{./sections/prototype_app.tex}
